  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <Input {...register("excerpt")} aria-invalid={!!errors.excerpt} />
        {fieldErr("excerpt") && (
          <p className="mt-1 text-sm text-destructive">{fieldErr("excerpt")}</p>
        )}
        <Label className="mt-3">
          {t("excerpt")} · EN · {tf("optional")}
        </Label>
        <Input {...register("excerptEn")} />
      </div>
      ...
      <div>
        ...
        {fieldErr("content") && (
          <p className="mt-1 text-sm text-destructive">{fieldErr("content")}</p>
        )}
        <Label className="mt-3">
          {t("content")} · EN · {tf("optional")}
        </Label>
